    ...
    <div className='bg-black'>
      <div className='container'>
        <div className='row py-5'>
          <div className='col-12 d-flex flex-column flex-lg-row justify-content-between mt-4' >
            <div>
              ...
              <p className='text-white'>Copyright 2023 MTNT Inc. Terms & Privacy</p>
            </div>
            <div className='d-flex justify-content-lg-end flex-column flex-lg-row'>
              <div className='me-5'>
